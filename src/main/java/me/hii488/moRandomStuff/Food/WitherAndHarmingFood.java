...
public class WitherAndHarmingFood extends ItemFood{

	public WitherAndHarmingFood(int p_i45339_1_, float p_i45339_2_, boolean p_i45339_3_) {
	...
	protected void onFoodEaten(ItemStack itemstack, World world, EntityPlayer player){
		if(!world.isRemote){
			player.addPotionEffect(new PotionEffect(Potion.wither.id, 500, 0));
			player.addPotionEffect(new PotionEffect(Potion.harm.id, 500, 0));
		}
	}
