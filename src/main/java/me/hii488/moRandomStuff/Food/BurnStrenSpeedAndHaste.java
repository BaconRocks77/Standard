...
public class BurnStrenSpeedAndHaste extends ItemFood{

	public BurnStrenSpeedAndHaste(int p_i45339_1_, float p_i45339_2_, boolean p_i45339_3_) {
	...
	protected void onFoodEaten(ItemStack itemstack, World world, EntityPlayer player){
		if(!world.isRemote){
			...
			player.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 500, 0));
