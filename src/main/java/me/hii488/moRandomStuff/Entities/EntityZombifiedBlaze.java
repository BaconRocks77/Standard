...
public class EntityZombifiedBlaze extends EntityMob
{
    ...
    public EntityZombifiedBlaze(World p_i1731_1_)
    {
        super(p_i1731_1_);
    ...
    protected void dropFewItems(boolean par1, int par2){
		int random = this.rand.nextInt(11) + this.rand.nextInt(1 + par2);
