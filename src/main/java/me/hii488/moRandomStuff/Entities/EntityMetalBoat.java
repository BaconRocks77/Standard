...
public class EntityMetalBoat extends Entity
{
    ...
    public EntityMetalBoat(World p_i1704_1_)
    {
        super(p_i1704_1_);
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityMetalBoat)
                        {
